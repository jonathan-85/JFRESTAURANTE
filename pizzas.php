...
<main class="container pt-5">
  <div class="row mt-md-5 mt-1">
    <div class="col-md-10 offset-md-1">
      <?php
      $query = "SELECT * FROM `Products` WHERE `product_type` = 'pizza'";
      $result = mysqli_query($conn, $query);
      if (mysqli_num_rows($result) == 0) {
        echo "<h1 class=\"text-center\">Todavía no hay Pizzas</h1>";
      } else {
        echo "<div class=\"row row-cols-md-3 row-cols-1 g-md-5 g-3\">";
